...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--with-endianness=little' '--enable-mini-agent' '--disable-debugging' '--disable-privacy' '--without-opaque-special-types' '--with-persistent-directory=/tmp/snmp-persist' '--with-default-snmp-version=3' '--with-sys-contact=root' '--with-sys-location=Unknown' '--with-logfile=/dev/null' '--with-out-transports=UDPIPv6,TCPIPv6,AAL5PVC,IPX,TCP,Unix' '--enable-shared=no' '--enable-static' '--with-gnu-ld' '--enable-internal-md5' '--with-copy-persistent-files=no' '--without-openssl' '-sysconfdir=/tmp' '--with-mib-modules=mibII,host,mibII/ip,mibII/tcp,mibII/udp,mibII/icmp,mibII/var_route,mibII/kernel_linux,ucd_snmp,agentx,notification,utilities,target' '--with-out-mib-modules=snmpv3mibs,agent_mips' '--disable-ipv6' '--with-defaults' '--without-efence' '--without-rsaref' '--without-kmem-usage' '--without-rpm' '--without-dmalloc'"
...
#define PACKAGE_STRING "Net-SNMP 5.6.2"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":HOST-RESOURCES-MIB:HOST-RESOURCES-TYPES:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-PASS-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/tmp/snmp-persist"
