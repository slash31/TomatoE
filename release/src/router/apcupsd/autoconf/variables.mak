...
MKINSTALLDIRS = /root/TomatoE/release/src/router/apcupsd/autoconf/mkinstalldirs
...
srcdir = .
abstopdir = /root/TomatoE/release/src/router/apcupsd
sbindir = /sbin
piddir = /var/run
...
LDFLAGS = -L/home/aaronfinney/tomato/tools/brcm/K26/hndtools-mipsel-uclibc-4.2.4/lib -ffunction-sections -fdata-sections
LIBS =  -lsupc++
LIBGD = 
POWERLIBS = 
