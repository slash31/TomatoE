...
#define TCONFIG_L7 1
  #define IF_TCONFIG_L7(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_L7(...)
...
#undef TCONFIG_NTFS
  #define IF_TCONFIG_NTFS(...)
  #define IF_NOT_TCONFIG_NTFS(...) __VA_ARGS__
#undef TCONFIG_BT
...
#define TCONFIG_QUAGGA 1
  #define IF_TCONFIG_QUAGGA(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_QUAGGA(...)
#undef TCONFIG_RIP
  #define IF_TCONFIG_RIP(...)
  #define IF_NOT_TCONFIG_RIP(...) __VA_ARGS__
#define TCONFIG_OSPF 1
  #define IF_TCONFIG_OSPF(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_OSPF(...)
#define TCONFIG_NETFLOW 1
  #define IF_TCONFIG_NETFLOW(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_NETFLOW(...)
#define TCONFIG_TCPDUMP 1
  #define IF_TCONFIG_TCPDUMP(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_TCPDUMP(...)
#define TCONFIG_UCARP 1
  #define IF_TCONFIG_UCARP(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_UCARP(...)
#undef TCONFIG_SDHC
...
#undef TCONFIG_NVRAM_64K
  #define IF_TCONFIG_NVRAM_64K(...)
  #define IF_NOT_TCONFIG_NVRAM_64K(...) __VA_ARGS__
#undef TCONFIG_TOR
  #define IF_TCONFIG_TOR(...)
  #define IF_NOT_TCONFIG_TOR(...) __VA_ARGS__
#define TCONFIG_IPSEC 1
  #define IF_TCONFIG_IPSEC(...) __VA_ARGS__
  #define IF_NOT_TCONFIG_IPSEC(...)
#undef TCONFIG_RAID
