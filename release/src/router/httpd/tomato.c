...
// advanced-routing
	...
	{ "drz_log",			V_01			},
	{ "drz_pwd",			V_LENGTH(0, 64)		},
#endif
#ifdef TCONFIG_RIP
	{ "drr_enable",			V_01			},
	{ "drr_pwd",			V_LENGTH(0, 64)		},
	{ "drr_lan",			V_01			},
	{ "drr_lan_pasv",		V_01			},
	{ "drr_lan_shz",		V_01			},
	{ "drr_lan_pwd",		V_LENGTH(0, 16)		},
	{ "drr_lan_md5",		V_01			},
	{ "drr_lan_txv",		V_LENGTH(1, 3)		},
	{ "drr_lan_rxv",		V_LENGTH(1, 3)		},
	{ "drr_lan1",			V_01			},
	{ "drr_lan1_pasv",		V_01			},
	{ "drr_lan1_shz",		V_01			},
	{ "drr_lan1_pwd",		V_LENGTH(0, 16)		},
	{ "drr_lan1_md5",		V_01			},
	{ "drr_lan1_txv",		V_LENGTH(1, 3)		},
	{ "drr_lan1_rxv",		V_LENGTH(1, 3)		},
	{ "drr_lan2",			V_01			},
	{ "drr_lan2_pasv",		V_01			},
	{ "drr_lan2_shz",		V_01			},
	{ "drr_lan2_pwd",		V_LENGTH(0, 16)		},
	{ "drr_lan2_md5",		V_01			},
	{ "drr_lan2_txv",		V_LENGTH(1, 3)		},
	{ "drr_lan2_rxv",		V_LENGTH(1, 3)		},
	{ "drr_lan3",			V_01			},
	{ "drr_lan3_pasv",		V_01			},
	{ "drr_lan3_shz",		V_01			},
	{ "drr_lan3_pwd",		V_LENGTH(0, 16)		},
	{ "drr_lan3_md5",		V_01			},
	{ "drr_lan3_txv",		V_LENGTH(1, 3)		},
	{ "drr_lan3_rxv",		V_LENGTH(1, 3)		},
	{ "drr_wan",			V_01			},
	{ "drr_wan_pasv",		V_01			},
	{ "drr_wan_shz",		V_01			},
	{ "drr_wan_pwd",		V_LENGTH(0, 16)		},
	{ "drr_wan_md5",		V_01			},
	{ "drr_wan_txv",		V_LENGTH(1, 3)		},
	{ "drr_wan_rxv",		V_LENGTH(1, 3)		},
	{ "drr_tmr_ud",			V_RANGE(0, 600000)	},
	{ "drr_tmr_to",			V_RANGE(0, 600000)	},
	{ "drr_tmr_gb",			V_RANGE(0, 600000)	},
	{ "drr_rdst_c",			V_01			},
	{ "drr_rdst_c_mt",		V_RANGE(0, 16777214)	},
	{ "drr_rdst_c_map",		V_LENGTH(0, 32)		},
	{ "drr_rdst_k",			V_01			},
	{ "drr_rdst_k_mt",		V_RANGE(0, 16777214)	},
	{ "drr_rdst_k_map",		V_LENGTH(0, 32)		},
	{ "drr_rdst_d",			V_01			},
	{ "drr_rdst_d_mt",		V_RANGE(0, 16777214)	},
	{ "drr_rdst_d_map",		V_LENGTH(0, 32)		},
	{ "drr_rdst_o",			V_01			},
	{ "drr_rdst_o_mt",		V_RANGE(0, 16777214)	},
	{ "drr_rdst_o_map",		V_LENGTH(0, 32)		},
	{ "drr_dlist_cfg",		V_LENGTH(0, 2048)	},
	{ "drr_addl_cfg", 		V_TEXT(0, 4096)		},
#endif
#ifdef TCONFIG_OSPF
	{ "dro_enable",			V_01			},
	{ "dro_pwd",			V_LENGTH(0, 64)		},
	{ "dro_lan",			V_01			},
	{ "dro_lan_psv",		V_01			},
	{ "dro_lan_ar",			V_LENGTH(0, 11)		},
	{ "dro_lan_mt",			V_RANGE(0, 65535)	},
	{ "dro_lan_pwd",		V_LENGTH(0, 32)		},
	{ "dro_lan_hpwd",		V_LENGTH(0, 64)		},
	{ "dro_lan_md5",		V_01			},
	{ "dro_lan_pr",			V_RANGE(0, 255)		},
	{ "dro_lan_hl",			V_RANGE(0, 65535)	},
	{ "dro_lan_rt",			V_RANGE(0, 65535)	},
	{ "dro_lan_dt",			V_RANGE(0, 65535)	},
	{ "dro_lan1",			V_01			},
	{ "dro_lan1_psv",		V_01			},
	{ "dro_lan1_ar",		V_LENGTH(0, 11)		},
	{ "dro_lan1_mt",		V_RANGE(0, 65535)	},
	{ "dro_lan1_pwd",		V_LENGTH(0, 32)		},
	{ "dro_lan1_hpwd",		V_LENGTH(0, 64)		},
	{ "dro_lan1_md5",		V_01			},
	{ "dro_lan1_pr",		V_RANGE(0, 255)		},
	{ "dro_lan1_hl",		V_RANGE(0, 65535)	},
	{ "dro_lan1_rt",		V_RANGE(0, 65535)	},
	{ "dro_lan1_dt",		V_RANGE(0, 65535)	}, 
	{ "dro_lan2",			V_01			},
	{ "dro_lan2_psv",		V_01			},
	{ "dro_lan2_ar",		V_LENGTH(0, 11)		},
	{ "dro_lan2_mt",		V_RANGE(0, 65535)	},
	{ "dro_lan2_pwd",		V_LENGTH(0, 32)		},
	{ "dro_lan2_hpwd",		V_LENGTH(0, 64)		},
	{ "dro_lan2_md5",		V_01			},
	{ "dro_lan2_pr",		V_RANGE(0, 255)		},
	{ "dro_lan2_hl",		V_RANGE(0, 65535)	},
	{ "dro_lan2_rt",		V_RANGE(0, 65535)	},
	{ "dro_lan2_dt",		V_RANGE(0, 65535)	}, 
	{ "dro_lan3",			V_01			},
	{ "dro_lan3_psv",		V_01			},
	{ "dro_lan3_ar",		V_LENGTH(0, 11)		},
	{ "dro_lan3_mt",		V_RANGE(0, 65535)	},
	{ "dro_lan3_pwd",		V_LENGTH(0, 32)		},
	{ "dro_lan3_hpwd",		V_LENGTH(0, 64)		},
	{ "dro_lan3_md5",		V_01			},
	{ "dro_lan3_pr",		V_RANGE(0, 255)		},
	{ "dro_lan3_hl",		V_RANGE(0, 65535)	},
	{ "dro_lan3_rt",		V_RANGE(0, 65535)	},
	{ "dro_lan3_dt",		V_RANGE(0, 65535)	}, 
	{ "dro_wan",			V_01			},
	{ "dro_wan_psv",		V_01			},
	{ "dro_wan_ar",			V_LENGTH(0, 11)		},
	{ "dro_wan_mt",			V_RANGE(0, 65535)	},
	{ "dro_wan_pwd",		V_LENGTH(0, 32)		},
	{ "dro_wan_hpwd",		V_LENGTH(0, 64)		},
	{ "dro_wan_md5",		V_01			},
	{ "dro_wan_pr",			V_RANGE(0, 255)		},
	{ "dro_wan_hl",			V_RANGE(0, 65535)	},
	{ "dro_wan_rt",			V_RANGE(0, 65535)	},
	{ "dro_wan_dt",			V_RANGE(0, 65535)	}, 
	{ "dro_rfc1583",		V_01			},
	{ "dro_log",			V_01			},
	{ "dro_log_adj",		V_01			},
	{ "dro_id",			V_LENGTH(0, 11)		},
	{ "dro_spf_del",		V_RANGE(0, 600000)	},
	{ "dro_spf_hold",		V_RANGE(0, 600000)	},
	{ "dro_spf_mhold",		V_RANGE(0, 600000)	},
	{ "dro_rdst_c",			V_01			},
	{ "dro_rdst_c_mtype",		V_RANGE(1, 2)		},
	{ "dro_rdst_c_mt",		V_RANGE(0, 16777214)	},
	{ "dro_rdst_c_map",		V_LENGTH(0, 32)		},
	{ "dro_rdst_k",			V_01			},
	{ "dro_rdst_k_mtype",		V_RANGE(1, 2)		},
	{ "dro_rdst_k_mt",		V_RANGE(0, 16777214)	},
	{ "dro_rdst_k_map",		V_LENGTH(0, 32)		},
	{ "dro_rdst_d",			V_01			},
	{ "dro_rdst_d_mtype",		V_RANGE(1, 2)		},
	{ "dro_rdst_d_mt",		V_RANGE(0, 16777214)	},
	{ "dro_rdst_d_map",		V_LENGTH(0, 32)		},
	{ "dro_rdst_r",			V_01			},
	{ "dro_rdst_r_mtype",		V_RANGE(1, 2)		},
	{ "dro_rdst_r_mt",		V_RANGE(0, 16777214)	},
	{ "dro_rdst_r_map",		V_LENGTH(0, 32)		},
	{ "dro_ac_bw",			V_RANGE(0, 10000)	},
	{ "dro_abr_type",		V_LENGTH(0, 8)		},
	{ "dro_ar_cfg",			V_LENGTH(0, 2048)	},
	{ "dro_addl_cfg", 		V_TEXT(0, 4096)		},
#endif
#ifdef TCONFIG_TCPDUMP
	{ "tcpdump_on",			V_01			},
	{ "tcpdump_file",		V_LENGTH(0, 60)		},
	{ "tcpdump_int",		V_LENGTH(0, 15)		},
	{ "tcpdump_loghost",		V_LENGTH(0, 15)		},
	{ "tcpdump_dir",		V_LENGTH(0, 5)		},
	{ "tcpdump_flval",		V_RANGE(0,60000)	},
	{ "tcpdump_fltype",		V_LENGTH(0, 1)		},
	{ "tcpdump_numf",		V_RANGE(0,999)		},
#endif
...
// nas-ftp - !!TB
	...
	{ "nflow_enable",		V_RANGE(0, 1)			},
	{ "nflow_dst",			V_LENGTH(0, 512)		},
	{ "nflow_saddr",		V_LENGTH(0, 512)		},
	{ "nflow_args",			V_LENGTH(0, 512)		},
	{ "nflow_ver",			V_RANGE(0, 9)			},
#endif
